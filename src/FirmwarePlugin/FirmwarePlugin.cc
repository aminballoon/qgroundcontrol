...
const QVariantList &FirmwarePlugin::toolIndicators(const Vehicle*)
{
    ...
    if (_toolIndicatorList.isEmpty()) {
        _toolIndicatorList = QVariantList({
            ...
            QVariant::fromValue(QUrl::fromUserInput("qrc:/qml/QGroundControl/Toolbar/VehicleGPS2Indicator.qml")),
            QVariant::fromValue(QUrl::fromUserInput("qrc:/qml/QGroundControl/Toolbar/VehiclePrecisionLandIndicator.qml")),
            ...
            QVariant::fromValue(QUrl::fromUserInput("qrc:/qml/QGroundControl/Toolbar/WindIndicator.qml")),
